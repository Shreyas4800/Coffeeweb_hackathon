      ...
      <div className="social-login-icons">
        ...
        <div className="socialcontainer">
          <div className="icon social-icon-2-2">
            <svg fill="#ffcb74" className="svgIcon" viewBox="0 0 448 512" height="1.5em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="socialcontainer">
          <div className="icon social-icon-3-3">
            <svg viewBox="0 0 384 512" fill="#ffcb74" height="1.6em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="socialcontainer">
          <div className="icon social-icon-4-4">
            <svg fill="#ffcb74" viewBox="0 0 496 512" height="1.6em">
